...
public final class LingoSceneIds {
    ...
    public static final String GAME = "lingo.game";
    public static final String PAUSE = "lingo.pause";
    public static final String GAME_OVER = "lingo.game_over";

    private LingoSceneIds() {
    }
}
